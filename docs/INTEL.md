...
## 👤 Rodrigo Gorgulho de Vasconcellos Lanna (Pai)
...
| **Estado Civil** | Casado com Rosália Fagundes Ladeira (desde 1992) |
...
### Empresas (8+ empresas, 6 ativas)
| Empresa | CNPJ | Papel | Status | Capital | Local |
|---------|------|-------|--------|---------|-------|
...
| Consórcio TKL | - | - | ❌ Baixada | - | - |
| EBTE Engenharia e Montagens LTDA | - | - | - | - | - |

### Processos Legais
- 7 processos judiciais (TRT3 e TRT21)
- Aparentemente disputas trabalhistas/cíveis de negócios
...
| Campo | Valor |
|-------|-------|
| **Nome** | Rosália Fagundes Ladeira |
| **Profissão** | Arquiteta |
| **RG** | MG-313.077 |
| **CPF** | 359.959.806-10 |
| **Empresa** | F Ladeira Consultoria Ltda (sócia desde 2020) |
| **Endereço** | Rua Prof Bartira Mourão, 546, Buritis, BH/MG |
...
| Nome | Profissão | Local | Observações |
|------|----------|-------|-------------|
...
## 👥 Irmãos de RGVL (Tios do Rodrigo Melo)

### Henrique Gorgulho de Vasconcellos Lanna ✅ CONFIRMADO
| Campo | Valor |
|-------|-------|
| **Parentesco** | Irmão de RGVL (Tio) |
| **Nascimento** | 22/05/1966 |
| **CREA** | MT13225/VD (Engenheiro/Agrônomo) |
| **Empresa** | ERH Lanna Engenharia Ltda |
| **CNPJ** | 02.835.659/0001-93 |
| **Endereço** | Rua Prof Bartira Mourão, 546, Apto 701, Buritis, BH/MG |
| **CEP** | 30492-025 |
| **CPF** | ***.257.066-* |
| **Status** | Empresa baixada (jun/2024) |
| **Processos** | 16+ processos no TJMG (cível, condomínio, contrato) |

### Marcelo Gorgulho de Vasconcellos Lanna ✅ CONFIRMADO
| Campo | Valor |
|-------|-------|
| **Parentesco** | Irmão de RGVL (Tio) |
| **Local** | Belo Horizonte, MG |
...
| Campo | Valor |
|-------|-------|
| **Parentesco** | Irmã de RGVL (Tia) |
| **CPF** | 064.327.216-01 |
| **Atividade** | Vice-Presidente AVOSC (2011), Presidente AVOSC (2016) |
| **Associação** | AVOSC (Assoc. Voluntárias Santa Casa - CNPJ 17.508.888/0001-70) |

---

## 👴 Avós de RGVL

### Edmundo de Vasconcellos Lanna ✅ CONFIRMADO
| Campo | Valor |
|-------|-------|
| **Parentesco** | Avô (Pai de RGVL) |
| **Nascimento** | 24/04/1922, Barra Longa/MG |
| **Profissão** | Dentista |
| **CPF** | 000.558.676-* |
| **Falecimento** | 04/11/1992 |
| **Sepultamento** | Belo Horizonte |
| **Propriedade BH** | Apto 402, Ed. Rio Verde, Rua Nisio Batista de Oliveira, 158, Novo São Lucas |

### Nice Gorgulho de Vasconcellos Lanna ✅ CONFIRMADO
| Campo | Valor |
|-------|-------|
| **Parentesco** | Avó (Mãe de RGVL) |
| **Nascimento** | 1926 |
| **Falecimento** | 2019 |
...
### ✅ Confirmados
- Geração 4 (Bisavôs): Edmundo Mariano da Costa Lanna (1878-1968) + Maria da Glória de Vasconcellos
- Irmãos do avô: Thereza (1923-2006), Maria Auxiliadora (1925-2018)
- Geração 3 (Avós): Edmundo (1922-1992) + Nice (1926-2019)
- Geração 2 (Pais): Rodrigo Gorgulho (nasc. 1955) + Rosália
- Geração 1 (Você): Rodrigo Melo
- Tios: Henrique (nasc. 1966), Marcelo, Júnia

### ❌ Pendentes
- Outros filhos de RGVL (irmãos do Rodrigo Melo)?
- Cônjuge de Henrique, Marcelo, Júnia?
- Filhos dos tios (primos)?
